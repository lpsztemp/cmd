...
echo define(HIGHLIGHT_KEYWORDS, `HIGHLIGHT_TAGS(``$*'', `class', `template', `const', `volatile', `struct', `int', `long', `short', `char', `double', `float', `bool', `true', `false', `auto', `typedef', `noexcept', `enum', `constexpr', `signed', `unsigned', `operator', `explicit', `nullptr')')dnl >> "%M4_OUTPUT%"
